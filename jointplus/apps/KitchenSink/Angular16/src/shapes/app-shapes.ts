...
export namespace app {
    ...
    export class RectangularModel extends joint.shapes.standard.Rectangle {
        ...
        defaults() {
            ...
            return joint.util.defaultsDeep({
                ...
                size: {
                    width: 200,  // Increase this value to make the card wider
                    height: 100  // You can adjust the height as well if needed
                },
                attrs: {
                    root: {
                        magnet: false
    ...
    export class ActivityModel extends joint.shapes.standard.EmbeddedImage {
        defaults() {
            return joint.util.defaultsDeep({
    ...
    export class AreaModel extends joint.shapes.standard.EmbeddedImage {
        defaults() {
            return joint.util.defaultsDeep({
                type: 'app.AreaModel',
                attrs: {

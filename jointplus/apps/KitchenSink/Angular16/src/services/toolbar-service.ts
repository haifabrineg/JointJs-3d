...
export class ToolbarService {
    ...
    create(commandManager: joint.dia.CommandManager, paperScroller: joint.ui.PaperScroller, graph: joint.dia.Graph) {
        const { tools, groups } = this.getToolbarConfig(graph);
    ...
    getToolbarConfig(graph: joint.dia.Graph) {
        ...
        return {
            ...
            tools: [
                ...
                // Existing tools omitted for brevity...
                {
                    type: 'button',
                    name: 'save',
                    group: 'save',
                    ...
                    attrs: {
                        button: {
                            id: 'btn-save',
                            'data-tooltip': 'Save the diagram toolbar',
                            'data-tooltip-position': 'top',
                            'data-tooltip-position-selector': '.toolbar-container'
                        }
                    },

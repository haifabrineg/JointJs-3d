...
export class InspectorService {
    ...
    getInspectorConfig() {
        ...
        const options = {
            ...
            imageIconsActivity: [
                    { value: '/assets/activity1.png', content: '<img height="100px" src="/assets/activity1.png"/>' },
                    { value: '/assets/activity2.png', content: '<img height="100px" src="/assets/activity2.png"/>' }
            ],
            imageIconsArea: [
                    { value: '/assets/area1.png', content: '<img height="100px" src="/assets/area1.png"/>' },
                    { value: '/assets/area2.png', content: '<img height="100px" src="/assets/area2.png"/>' }
            ],
            imageIcons: [
                //TODO replace this list with the png of spline created elements ( backend since we will add crud )
                { value: '/assets/Desk.png', content: '<img height="100px"  width="100px" src="/assets/Desk.png"/>' },
                { value: '/assets/Database.jpg', content: '<img height="100px" width="100px" src="/assets/Database.jpg"/>' },
                { value: '/assets/Sec.jpg', content: '<img height="100px" width="100px" src="/assets/Sec.jpg"/>' },
            ],
                ...
                inputs: {
                    attrs: {
                        ...
                        image: {
                            xlinkHref: {
                                type: 'select-box',
                                options: options.imageIconsActivity,
                                label: 'Image',
                                group: 'image',
                                index: 1
                            }
